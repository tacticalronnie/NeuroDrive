    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on NeuroDrive!`,
        ...
        <div className="w-full lg:w-5/12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-6">
            <div className="flex items-center gap-2">
              ...
              <span>{car.mileage.toLocaleString()} kilometers</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <Dialog>
              ...
              <Card className="pt-5">
                <CardContent>
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    *Based on Rs0 down payment and 4.5% interest rate
                  </div>
                </CardContent>
              </Card>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>NeuroDrive Car Loan Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <a href="mailto:neurodrive@gmail.com">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
            ...
            <div className="flex justify-between py-2 border-b">
              ...
              <span className="font-medium">
                {car.mileage.toLocaleString()} kilometers
              </span>
            </div>
            <div className="flex justify-between py-2 border-b">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">NeuroDrive</h4>
